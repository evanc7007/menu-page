...
function Accordion({ children }: Props) {
    ...
    return (
        <>
            <h2 className="accordionTitle">{children}</h2>
            <div className="accordion" id="accordionExample">
                ...
                <CategoryDropdown title="Soup">
                    Comes with Fried Crispy Noodles.
                    <hr></hr>
                ...
                <CategoryDropdown title="Lunch Special">
                    Served Tues - Sat, 11:00am - 2:30pm. Comes with Plain Fried Rice, add $1 for Pork Fried Rice.
                    <hr></hr>
